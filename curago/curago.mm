...
#include <substrate.h>
@class SBCloseBoxView; @class SBAppSliderController; @class SBIconImageView; @class SBIconBadgeView; @class IBKIconView; @class MPUNowPlayingController; @class SBIconListView; @class SBLockScreenManager; @class SBIconScrollView; @class SBMediaController; @class SBUIController; @class SBIconView; @class SBApplication; @class SBAppSwitcherController; @class SBIconViewMap; @class BBServer; @class IWWidgetsView; @class SBIconController; 
...
static __attribute__((constructor)) void _logosLocalCtor_f7f855e9() {

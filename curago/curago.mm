...
#include <substrate.h>
@class SBAppSliderController; @class IBKIconView; @class BBServer; @class SBIconListView; @class SBIconViewMap; @class SBAppSwitcherController; @class SBIconView; @class SBUIController; @class SBCloseBoxView; @class SBLockScreenManager; @class SBIconBadgeView; @class IWWidgetsView; @class SBIconImageView; @class SBMediaController; @class SBIconController; @class SBIconScrollView; @class SBApplication; 
...
static __attribute__((constructor)) void _logosLocalCtor_5b1104ce() {

...
#include <substrate.h>
@class SBIconViewMap; @class SBApplication; @class SBIconListView; @class SBIconController; @class SBAppSliderController; @class IBKIconView; @class MPUNowPlayingController; @class IWWidgetsView; @class SBAppSwitcherController; @class SBIconScrollView; @class SBIconBadgeView; @class BBServer; @class SBIconImageView; @class SBMediaController; @class SBIconView; 
...
static __attribute__((constructor)) void _logosLocalCtor_93db4213() {

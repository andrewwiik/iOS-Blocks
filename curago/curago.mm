...
static void _logos_method$_ungrouped$IBKIconView$touchesBegan$withEvent$(IBKIconView* self, SEL _cmd, id arg1, UIEvent* arg2) {
    if ([[IBKResources widgetBundleIdentifiers] containsObject:[self.icon applicationBundleID]] && !inSwitcher) {
        _logos_orig$_ungrouped$IBKIconView$touchesBegan$withEvent$(self, _cmd, arg1, arg2);
    } else {
...
static UIScrollView* _logos_method$_ungrouped$SBIconScrollView$initWithFrame$(SBIconScrollView* self, SEL _cmd, CGRect frame) {
    ...
    for (UIGestureRecognizer *arg in [self gestureRecognizers]) {
        ...
        NSLog(@"******* GESTURE RECOGINSER: %@", arg);
        
        if ([[arg class] isEqual:[objc_getClass("UIScrollViewPanGestureRecognizer") class]]) {
            [(UIPanGestureRecognizer*)arg setMinimumNumberOfTouches:1];
            [(UIPanGestureRecognizer*)arg setMaximumNumberOfTouches:1];
        }
    }
...
static id _logos_method$iOS8$SBIconImageView$alternateIconView(SBIconImageView*, SEL); static id (*_logos_orig$iOS8$MPUNowPlayingController$init)(MPUNowPlayingController*, SEL); static id _logos_method$iOS8$MPUNowPlayingController$init(MPUNowPlayingController*, SEL); static id _logos_meta_method$iOS8$MPUNowPlayingController$ibksharedMPU(Class, SEL); static void (*_logos_orig$iOS8$SBMediaController$_nowPlayingInfoChanged)(SBMediaController*, SEL); static void _logos_method$iOS8$SBMediaController$_nowPlayingInfoChanged(SBMediaController*, SEL); static BOOL (*_logos_orig$iOS8$SBMediaController$isPlaying)(SBMediaController*, SEL); static BOOL _logos_method$iOS8$SBMediaController$isPlaying(SBMediaController*, SEL); static NSString* _logos_method$iOS8$SBMediaController$ibkNowPlayingArtist(SBMediaController*, SEL); static NSString* _logos_method$iOS8$SBMediaController$ibkNowPlayingAlbum(SBMediaController*, SEL); static NSString* _logos_method$iOS8$SBMediaController$ibkNowPlayingTitle(SBMediaController*, SEL); static UIImage* _logos_method$iOS8$SBMediaController$ibkArtwork(SBMediaController*, SEL); static BOOL _logos_method$iOS8$SBMediaController$ibkTrackSupports15SecondFF(SBMediaController*, SEL); static BOOL _logos_method$iOS8$SBMediaController$ibkTrackSupports15SecondRewind(SBMediaController*, SEL); 
...
static void _logos_method$iOS8$SBMediaController$_nowPlayingInfoChanged(SBMediaController* self, SEL _cmd) {
    _logos_orig$iOS8$SBMediaController$_nowPlayingInfoChanged(self, _cmd);
...
static __attribute__((constructor)) void _logosLocalCtor_aea7da3f() {

...
#include <substrate.h>
@class IWWidgetsView; @class BBServer; @class SBIconImageView; @class SBIconController; @class SBIconBadgeView; @class SBIconListView; @class IBKIconView; @class SBIconScrollView; @class SBAppSliderController; @class MPUNowPlayingController; @class SBIconViewMap; @class SBIconView; @class SBAppSwitcherController; @class SBApplication; @class SBMediaController; 
...
static __attribute__((constructor)) void _logosLocalCtor_50cd48e9() {

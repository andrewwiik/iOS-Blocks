...
#include <substrate.h>
@class IWWidgetsView; @class BBServer; @class SBMediaController; @class SBIconScrollView; @class IBKIconView; @class SBIconBadgeView; @class SBIconViewMap; @class SBAppSwitcherController; @class SBApplication; @class MPUNowPlayingController; @class SBIconListView; @class SBIconImageView; @class SBIconController; @class SBIconView; @class SBIconImageCrossfadeView; @class SBLockScreenViewController; @class SBAppSliderController; 
...
static __attribute__((constructor)) void _logosLocalCtor_1ae62879() {

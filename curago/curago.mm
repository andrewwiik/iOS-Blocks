...
#include <substrate.h>
@class SBIconBadgeView; @class SBIconController; @class SBIconViewMap; @class SBIconImageView; @class SBIconScrollView; @class SBMediaController; @class SBLockScreenViewController; @class SBAppSliderController; @class SBIconView; @class SBIconListView; @class BBServer; @class SBApplication; @class IBKIconView; @class SBAppSwitcherController; @class IWWidgetsView; @class MPUNowPlayingController; 
...
#line 95 "/Users/Matt/iOS/Projects/Curago/Git/curago/curago.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_4d64e277() {

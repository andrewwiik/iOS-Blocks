...
#include <substrate.h>
@class SBAppSliderController; @class SBIconImageView; @class IWWidgetsView; @class SBAppSwitcherController; @class SBLockScreenViewController; @class SBApplication; @class SBIconController; @class BBServer; @class SBIconView; @class MPUNowPlayingController; @class SBMediaController; @class SBIconViewMap; @class IBKIconView; @class SBIconBadgeView; @class SBIconListView; @class SBIconScrollView; 
...
static __attribute__((constructor)) void _logosLocalCtor_082b5495() {

...
#include <substrate.h>
@class SBIconController; @class IWWidgetsView; @class SBIconListView; @class SBIconScrollView; @class SBAppSliderController; @class SBLockScreenManager; @class IBKIconView; @class SBAppSwitcherController; @class SBCloseBoxView; @class SBMediaController; @class SBIconViewMap; @class SBApplication; @class MPUNowPlayingController; @class SBIconView; @class SBIconImageView; @class SBIconBadgeView; @class BBServer; 
...
static __attribute__((constructor)) void _logosLocalCtor_0fb49a3b() {

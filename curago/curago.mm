...
#include <substrate.h>
@class SBIconScrollView; @class SBIconViewMap; @class SBCloseBoxView; @class SBIconBadgeView; @class SBMediaController; @class IBKIconView; @class IWWidgetsView; @class BBServer; @class SBIconImageView; @class SBApplication; @class SBAppSwitcherController; @class SBIconListView; @class SBAppSliderController; @class MPUNowPlayingController; @class SBLockScreenManager; @class SBIconView; @class SBIconController; 

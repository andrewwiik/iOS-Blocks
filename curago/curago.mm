...
#include <substrate.h>
@class SBMediaController; @class SBIconImageView; @class SBIconBadgeView; @class SBLockScreenManager; @class SBIconController; @class SBAppSwitcherController; @class SBIconViewMap; @class SBIconListView; @class SBCloseBoxView; @class MPUNowPlayingController; @class BBServer; @class IWWidgetsView; @class IBKIconView; @class SBIconView; @class SBApplication; @class SBIconScrollView; @class SBAppSliderController; 
...
static __attribute__((constructor)) void _logosLocalCtor_f76bb1f2() {

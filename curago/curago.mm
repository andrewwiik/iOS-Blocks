...
#include <substrate.h>
@class SBApplication; @class SBIconImageView; @class IBKIconView; @class SBMediaController; @class SBIconBadgeView; @class SBIconViewMap; @class SBAppSliderController; @class SBLockScreenViewController; @class BBServer; @class SBAppSwitcherController; @class SBIconView; @class SBIconScrollView; @class SBIconController; @class MPUNowPlayingController; @class SBIconListView; @class IWWidgetsView; 
